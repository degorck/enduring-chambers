...
class RowMapper:
    ...
    RowMapper Class
    """
    def row_to_row_dto(self, row:Row):
        """
        ...
        if row.get_module() is None:
            ...
            row_dto.set_module(module_mapper.module_to_module_dto(row.get_module()))
    ...
    def row_dto_to_row(self, row_dto:RowDto):
        """
        ...
        if row_dto.get_module() is None:
            ...
            row.set_module(module_mapper.module_dto_to_module(row_dto.get_module()))
