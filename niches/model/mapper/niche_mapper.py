...
from niches.model.mapper.row_mapper import RowMapper
...
class NicheMapper:
    ...
    def __init__(self):
        ...
        self.__row_mapper = RowMapper()

    def niche_to_niche_dto(self, niche:Niche):
        """
        ...
        if niche.get_row() is None:
            ...
            niche_dto.set_row(self.__row_mapper.row_to_row_dto(niche.get_row()))
        ...
        if niche.get_holder() is None:
            ...
            niche_dto.set_holder(self.__holder_mapper.holder_to_holder_dto(niche.get_holder()))
    ...
    def niche_dto_to_niche(self, niche_dto:NicheDto):
        """
        ...
        if niche_dto.get_row() is None:
            ...
            niche.set_row(self.__row_mapper.row_dto_to_row(niche_dto.get_row()))
        ...
        if niche_dto.get_holder() is None:
            ...
            niche.set_holder(self.__holder_mapper.holder_dto_to_holder(niche_dto.get_holder()))
