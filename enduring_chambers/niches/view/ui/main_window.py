...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_version = QLabel(self.frame_lateral_window)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_version.setText(QCoreApplication.translate("MainWindow", u"ver.", None))
        ...
        self.label_create_niche_name.setText(QCoreApplication.translate("MainWindow", u".", None))
