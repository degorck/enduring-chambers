...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetContents_21.setGeometry(QRect(0, 0, 196, 872))
...
"}")
        ...
        self.scrollAreaWidgetContents_22.setGeometry(QRect(0, 0, 196, 842))
...
"}")
        ...
        self.label_last_record = QLabel(self.scrollAreaWidgetContents_6)
        self.label_last_record.setObjectName(u"label_last_record")
        self.label_last_record.setAlignment(Qt.AlignmentFlag.AlignCenter)

        self.verticalLayout_3.addWidget(self.label_last_record)

        self.label_create_niche_name = QLabel(self.scrollAreaWidgetContents_6)
        self.label_create_niche_name.setObjectName(u"label_create_niche_name")
        self.label_create_niche_name.setAlignment(Qt.AlignmentFlag.AlignCenter)

        self.verticalLayout_3.addWidget(self.label_create_niche_name)

        self.label_name_create_niche = QLabel(self.scrollAreaWidgetContents_6)
        self.label_name_create_niche.setObjectName(u"label_name_create_niche")

        self.verticalLayout_3.addWidget(self.label_name_create_niche)

        self.line_edit_create_niche_name = QLineEdit(self.scrollAreaWidgetContents_6)
        self.line_edit_create_niche_name.setObjectName(u"line_edit_create_niche_name")

        self.verticalLayout_3.addWidget(self.line_edit_create_niche_name)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_last_record.setText(QCoreApplication.translate("MainWindow", u"\u00daltimo registro", None))
        self.label_create_niche_name.setText(QCoreApplication.translate("MainWindow", u"nombre", None))
        self.label_name_create_niche.setText(QCoreApplication.translate("MainWindow", u"Nombre:", None))
        self.line_edit_create_niche_name.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Consecutivo al \u00faltimo record...", None))
