"""
User Data Transfer Object Module
"""
import datetime

class UserDto:
    """
    Class with the Data Transfer Object builders
    """
    def __init__(self):
        self.__id:int = 0
        self.__name:str = ""
    ...
    def new_user(self, name:str, paternal_surname:str,
                 maternal_surname:str, user_type:int,
